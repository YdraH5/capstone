<div>
    <div class="flex">
        <input wire:model.debounce.100ms.live="search" type="search" class="mb-5 mt-2 text-black-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-1/2 h-8 flex items-center pl-3 text-sm border-black rounded border" placeholder="Search...">
    </div>
